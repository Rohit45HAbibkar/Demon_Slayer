...
const RCard = ({ imageSrc, title, description }) => {
  return (
    <section id="hashira" className="w-full h-screen flex items-center justify-center">
      <div className="max-w-7xl mt-12 bg-white shadow-2xl rounded-lg overflow-hidden flex h-[32rem] ml-auto mr-4">
